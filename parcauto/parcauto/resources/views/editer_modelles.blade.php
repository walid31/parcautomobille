...
@section('content')
    <form action="{{route('update_modelle',['id'=>$modelles->id_modelle])}}" method="post">
        {{ csrf_field()}}

        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Modifier modelle </h3>
                ...
                <div class="row">
                    <div class="col-xs-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputl" name='nom_modelle' value="{{$modelles->name_modelle}}" placeholder="Enter nom">
                        </div>
